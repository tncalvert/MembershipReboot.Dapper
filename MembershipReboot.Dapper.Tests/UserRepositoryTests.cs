...
namespace MembershipReboot.Dapper.Tests {
    public class UserRepositoryTests : IDisposable, IClassFixture<CheckDatabase> {
        ...
        public static DapperUserAccountRepository<RelationalUserAccount> CreateRepository(IDbConnection connection) {
            var repo = new DapperUserAccountRepository<RelationalUserAccount>(connection);
            return repo;
        }

        public static DapperUserAccountRepository<RelationalUserAccount> CreateRepository(IDbConnection connection, string userAccountTable,
